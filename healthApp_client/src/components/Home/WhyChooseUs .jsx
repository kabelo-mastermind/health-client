      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-left sm:text-center">
          ...
          <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">
            Discover the benefits of our healthcare services designed to simplify appointment management and enhance patient care. Here’s why our solution stands out.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-8 sm:space-x-12 sm:mt-12 sm:flex sm:items-start sm:justify-center sm:space-y-0 md:space-x-20 lg:mt-20">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold text-black">Streamlined Appointment Scheduling</h3>
              <p className="mt-1.5 text-base text-gray-600">Effortlessly manage and schedule appointments with our intuitive system, ensuring a smooth experience for both patients and providers.</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold text-black">Enhanced Data Security</h3>
              <p className="mt-1.5 text-base text-gray-600">Protect sensitive patient information with our robust security protocols and compliance with healthcare regulations.</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold text-black">User-Friendly Interface</h3>
              <p className="mt-1.5 text-base text-gray-600">Enjoy a seamless and user-friendly interface designed to make appointment scheduling and management easy for everyone.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-start mt-8 sm:justify-center sm:px-0">
          ...
          <span className="ml-2 text-sm text-gray-600">Your data is completely secured with us. We don’t share it with anyone.</span>
        </div>
      </div>
    </section>
    </div>
